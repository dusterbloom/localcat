...
from hotmem_v3_streaming_extraction import StreamingExtractor, StreamingVoiceProcessor

# Try to import inference module, fallback to basic implementation
try:
    from hotmem_v3_inference import HotMemInference
except ImportError:
...
class HotMemIntegration:
    ...
    def process_transcription(self, text: str, is_final: bool = False):
        ...
        if self.streaming_extractor:
            from hotmem_v3_streaming_extraction import StreamingChunk
    ...
    def _process_direct_inference(self, text: str, is_final: bool):
        ...
        try:
            ...
            from hotmem_v3_streaming_extraction import ExtractionResult
